...
# Annotate with ANNOVAR including REVEL scores
table_annovar.pl $OUT_DIR/${SAMPLE_NAME}_variants.avinput humandb/ -buildver hg19 -out $OUT_DIR/${SAMPLE_NAME}_annotated -remove -protocol refGene,cytoBand,exac03,avsnp147,dbnsfp30a,revel -operation g,r,f,f,f,f -nastring . -csvout -polish -xref example/gene_xref.txt
